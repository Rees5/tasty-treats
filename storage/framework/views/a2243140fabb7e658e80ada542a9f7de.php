    ...
    <?php if($useCalendarView): ?>
        <div class="col-md-9 pr-md-4">
            <div
                ...
                data-date="<?php echo e($__SELF__->getSelectedDate()->format('Y-m-d')); ?>"
                data-start-date="<?php echo e(isset($nextOpen) ? $nextOpen->format('Y-m-d') : null); ?>"
        ...
        <div class="col-md-3" id="ti-datepicker-options">
            <div class="form-group pt-4">
                <label for="locationSelect"><?php echo app('translator')->get('igniter.reservation::default.label_location'); ?></label>
                <?php echo controller()->renderPartial('@input_location'); ?>
            </div>
    ...
    <?php else: ?>
        <div class="col-sm-3 mb-3">
            <label
                class="sr-only"
                for="locationSelect"
            ><?php echo app('translator')->get('igniter.reservation::default.label_location'); ?></label>
            <?php echo controller()->renderPartial('@input_location'); ?>
        </div>
