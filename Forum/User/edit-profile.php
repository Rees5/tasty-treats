  ...
  <?php include 'top_nav.php'; ?>
    ...
    <div class="content">
        ...
        <div class="profile-info">
            <h2>Edit Profile</h2>
            <form action="../../src/auth/server_auth.php" method="post" id="form-profile" enctype="multipart/form-data">
                ...
                <br>
                    ...
                    <textarea name="about" style="width: 100%; height: 50px;"><?php echo $row['user_about']; ?></textarea>
                <br><br>
                <label>Image</label>
                <input type="file" name="img">
                <!--<br><a href="#">Change Password</a>
                <a href="#">Save</a>-->
                <input type="text" name="save" hidden>
                <div onClick='submitDetailsForm()' style="border-radius: 50px; cursor: pointer; background-color: rgba(22, 180, 180); width: 120px; padding-top: 15px; padding-bottom: 15px; padding-left: 35px; padding-right: 5px;">
                                <i class="fa fa-floppy-o" aria-hidden="true" style="color: white;"></i><a style="text-decoration: none; margin-left: 10px; color: white;">Submit</a>
